...
/*
    ...
    public AuthenticationResponse createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest) throws
        ...
        logger.info("in token method");
        try {
            logger.info("Enter in try Block Successfully");
            authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(authenticationRequest.getEmail(),authenticationRequest));
            logger.info("Passed The Try Block Successfully And We got ");
        }catch (BadCredentialsException e){
            logger.info("in the catch Block");
            throw new BadCredentialsException("Incorrect UserName or Password.");
        }
        logger.info("Passed catch Block Successfully");
